...
extern _Bool ds18b20_Configure(ds18b20Config_t *pds18b20Config){
    ...
    if(!__ds18b20_Check_Response())
    {
        __ds18b20_Write_byte(0xCC);
        __ds18b20_Write_byte(0x4E);
...
extern _Bool ds18b20_Read_ROM(uint64_t *promCode){
   ...
   __ds18b20_Start_Reset_Signal();
    ...
    if(!__ds18b20_Check_Response())
    {
        __ds18b20_Write_byte(0x33);

        romCode =(uint64_t) __ds18b20_Read_Byte();
        ...
        romCode|=( (uint64_t) __ds18b20_Read_Byte())<<56;
...
static void __ds18b20_Start_Reset_Signal(void){
    ...
    _delay((unsigned long)((480)*(48000000UL/4000000.0)));
...
static _Bool __ds18b20_Check_Response(void){
  ...
  while(PORTDbits.RD1 && TMR2<0x2E);



  while(!PORTDbits.RD1 && TMR2 < 0xB9);
...
extern _Bool ds18b20_Read_Raw_Temperature(uint16_t *rawTempValue){
    *rawTempValue = 0;
    ...
    {
        __ds18b20_Write_byte(0xCC);
        __ds18b20_Write_byte(0x44);

        while(__ds18b20_Read_Byte()==0) ;
