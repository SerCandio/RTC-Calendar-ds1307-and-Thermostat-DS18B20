...
extern void I2C_BeginMaster(uint32_t bitRateHz){
    ...
    SSP1ADD=(uint8_t) ( (48000000UL / bitRateHz ) / 4UL ) -1UL ;
...
extern _Bool I2C_WriteMaster(uint8_t data){
    ...
    ackStatus=(_Bool) (SSP1CON2bits.ACKSTAT);
...
extern _Bool I2C_WriteWordMaster(uint16_t data){
    ...
    if(I2C_WriteMaster( (uint8_t) ( (data>>8) & 0x000F ) )==1){
        return 1;

    }


    if(I2C_WriteMaster((uint8_t) (data& 0x00FF))==1){
        return 1;
