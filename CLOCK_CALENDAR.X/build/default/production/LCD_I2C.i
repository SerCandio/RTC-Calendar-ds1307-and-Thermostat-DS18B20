...
void LCD_I2C_DataBus(uint8_t a){
# 15 "LCD_I2C.c"
    lcdParalellData&=~(1<<7U) & ~(1<<6U) & ~(1<<5U) & ~(1<<4U) ;
    lcdParalellData|=(a & 0x0F)<<4;


    pcf8574_SendData(0x40, lcdParalellData);
