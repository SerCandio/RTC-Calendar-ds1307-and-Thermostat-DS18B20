...
extern _Bool DS1307_Conf_Init(rtcDs1307Control_t *prtcDs1307Control){
     memcpy(&rtcDs1307CtrlBuffer, prtcDs1307Control, sizeof(*prtcDs1307Control) );


    I2C_StartMaster();


    if(I2C_WriteMaster(0xD0) ==1){
         return 1;
    }


    if(I2C_WriteMaster(0x07) ==1){
         return 1;
    }
     ...
     if(I2C_WriteMaster(rtcDs1307CtrlBuffer) ==1){
         return 1;
     }
...
extern _Bool DS1307_Set_TimeDate(rtcDs1307UserData_t *prtcDs1307UserData){
   ...
   __DS1307_Build_To_TimeDate(&rtcDs1307TimeData, prtcDs1307UserData);

   memcpy(&rtcDs1307Buffer, &rtcDs1307TimeData, sizeof(rtcDs1307TimeData) );
    ...
    for(int i=0 ; i<sizeof(rtcDs1307Buffer) ;i++){
        if(I2C_WriteMaster(rtcDs1307Buffer[i]) ==1){
             return 1;
        }
    }
...
extern _Bool DS1307_Read_TimeDate(rtcDs1307UserData_t *prtcDs1307UserData){
    ...
    for(int i=0 ; i<sizeof(rtcDs1307Buffer);i++){
        if(i==(sizeof(rtcDs1307Buffer) - 1)){
            rtcDs1307Buffer[i]=I2C_ReadMaster(0);
            break;
        }
        rtcDs1307Buffer[i]=I2C_ReadMaster(1);
...
static void __DS1307_Build_To_TimeDate(rtcDs1307TimeData_t *prtcDs1307TimeData,rtcDs1307UserData_t *prtcDs1307UserData){
  ...
  prtcDs1307TimeData->hoursH=(prtcDs1307UserData->hours) /10 ;

  prtcDs1307TimeData->hourMode=prtcDs1307UserData->hour12Mode;
...
static void __DS1307_Retreive_From_TimeDate(rtcDs1307UserData_t *prtcDs1307UserData, rtcDs1307TimeData_t *prtcDs1307TimeData ){
    ...
    if(prtcDs1307TimeData->hourMode ==1){
