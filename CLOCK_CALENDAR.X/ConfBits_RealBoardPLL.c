...
extern void OSCILATOR_Init(void){
    OSCCONbits.OSTS=1; //Device is running from the clock defined by FOSC<3:0> of the CONFIG1H register
    OSCCON2bits.PLLEN=1; // PLL Enabled
    OSCCONbits.SCS=0b00; //Primary clock (determined by FOSC<3:0> in CONFIG1H).
